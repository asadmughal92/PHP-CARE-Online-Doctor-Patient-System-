              ...
              <div class="panel-body">
                <div class="col-lg-2 col-sm-2">
                  ...
                  <div class="follow-ava">
                    <img src="../admin/<?php echo $row->pic; ?>" alt="" width="50px" height="50px">
                  </div>
                  <h6>Doctor</h6>
                </div>
                    ...
                    <section class="panel">
                      ...
                      <div class="panel-body bio-graph-info">
                        ...
                        <div class="row">
                          ...
                          <div class="bio-row">
                            <p><span>City </span>: <?php echo $row->cname; ?></p>
                          </div>
                          <div class="bio-row">
                            <p><span>Department </span>: <?php echo $row->dname; ?></p>
                          </div>
                          <div class="bio-row">
                            <p><span>Email </span>:<?php echo $row->Email; ?></p>
                          </div>
                          <div class="bio-row">
                            <p><span>Mobile </span>: <?php echo $row->contact; ?></p>
                          </div>
                      ...
                      <div class="panel-body bio-graph-info">
                        ...
                        <form class="form-horizontal" role="form" action="function.php" method="post">
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="f-name" placeholder=" " name="fname" value="<?php echo $row->FirstName; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Last Name</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="l-name" name="lname" placeholder=" " value="<?php echo $row->LastName; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Address</label>
                            <div class="col-lg-10">
                              <textarea name="add" id="" class="form-control" cols="30" rows="5"><?php echo $row->Address; ?></textarea>
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Date of Birth</label>
                            <div class="col-lg-6">
                              <input type="Date" class="form-control" id="c-name" name="dob" placeholder=" " value="<?php echo $row->DOB; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Contact</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" name="contact" id="b-day" placeholder=" " value="<?php echo $row->contact; ?>">
                            </div>
                          </div>
                  
                         <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                              <button type="submit" class="btn btn-primary" name="updDoc">Update</button>
